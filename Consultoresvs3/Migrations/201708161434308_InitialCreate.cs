namespace Consultoresvs3.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IdUsuarioProyecto = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Servicios", t => t.IdServicio, cascadeDelete: true)
                .ForeignKey("dbo.UsuarioProyectoes", t => t.IdUsuarioProyecto, cascadeDelete: true)
                .Index(t => t.IdServicio)
                .Index(t => t.IdUsuarioProyecto);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ReporteUsuarios", "IdUsuarioProyecto", "dbo.UsuarioProyectoes");
            DropForeignKey("dbo.UsuarioProyectoes", "IdUsuario", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.UsuarioProyectoes", "IdProyecto", "dbo.Proyectoes");
            ...
            DropIndex("dbo.UsuarioProyectoes", new[] { "IdUsuario" });
            DropIndex("dbo.UsuarioProyectoes", new[] { "IdProyecto" });
            DropIndex("dbo.ReporteUsuarios", new[] { "IdUsuarioProyecto" });
